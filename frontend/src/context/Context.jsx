...
export const ContextProvider = ({ children }) => {
  ...
  const [gameScreenState, setGameScreenState] = useState({
    board:
      JSON.parse(sessionStorage.getItem("currentBoard")) ||
      Array.from({ length: 6 }, () => new Array(7).fill(null)),
    currentPlayer:
    ...
    gameOver: false,
    victoriesPlayerOne:
      parseInt(sessionStorage.getItem("victoriesPlayerOne"), 10) || 0,
    victoriesPlayerTwo:
      parseInt(sessionStorage.getItem("victoriesPlayerTwo"), 10) || 0,
